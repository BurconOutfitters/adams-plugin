...
class Settings {
	...
	public function __construct() {
		...
		add_filter( ADAMS_PARENT_PREFIX . '_tabs_site_settings', [ $this, 'site_settings_tab' ], 11 );

		// Do the settings section for the new tab.
		add_filter( ADAMS_PARENT_PREFIX . '_section_site_settings', [ $this, 'site_settings_section' ], 11 );

		// Do the settings fields for the new tab.
		add_filter( ADAMS_PARENT_PREFIX . '_fields_site_settings', [ $this, 'site_settings_fields' ], 11 );

		// Addon tab save button text.
		add_filter( ADAMS_PARENT_PREFIX . '_save_site_settings', [ $this, 'site_settings_save' ], 11 );
