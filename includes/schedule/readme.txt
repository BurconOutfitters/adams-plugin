...
Schedule does WordPress event management with richly customizable ways to display events. The plug-in supports individual event calendars within WordPress Multisite, multiple calendars displayed by categories, locations or author, or simple lists of upcoming events.

Easy to use for anybody, Schedule provides enormous flexibility for designers and developers needing a custom calendar. Schedule is built with accessibility in mind, so all your users can get equal access and experience in your calendar.

= Premium Event Management =
Looking for more? [Buy Schedule Pro](https://www.joedolson.com/my-calendar/pro/), the premium extension for Schedule to add support for user-submitted events, integration between posting and event creation, and import events from outside sources.

= Selling event tickets? =
Do you need to sell tickets for events? [Use My Tickets](https://wordpress.org/plugins/my-tickets/) and sell tickets for your Schedule events. Set prices, ticket availability, and sell multiple events at the same time using My Tickets.
...
*	Rich permissions handling to restrict access to parts of Schedule
...
*	Shortcode Generator to create customized views of Schedule

= What's in Schedule Pro? =
...
3. Configure Schedule using the settings pages in the admin panel:

   Schedule -> Add New Event
   Schedule -> Manage Events
   Schedule -> Event Groups
   Schedule -> Add New Location
   Schedule -> Manage Locations
   Schedule -> Manage Categories
   Schedule -> Style Editor
   Schedule -> Script Manager
   Schedule -> Template Editor
   Schedule -> Settings
   Schedule -> Help

4. Visit Schedule -> Help for assistance with shortcode options or widget configuration.
...
* Bug fix: Schedule could prevent canonical link from displaying if canonical link being filtered by another application.
...
* Bug fix: Make sure that the 's' query var is not automatically added to Schedule URLs
...
I will! But not in person. Take a look at my [documentation website for Schedule](http://docs.joedolson.com/my-calendar/) or [buy the User's Guide](https://www.joedolson.com/my-calendar/users-guide/) before making your request, and consider [making a donation](https://www.joedolson.com/donate/)!

= Can my visitors or members submit events? =

I've written a premium plug-in that adds this feature: Schedule Pro. [Buy it today](https://www.joedolson.com/my-calendar/pro/)!

= Is there an advanced search feature? =

The search feature in Schedule is pretty basic; but [buying Schedule Pro](https://www.joedolson.com/my-calendar/pro/) gives you a richer search feature, where you can narrow by dates, categories, authors, and more to refine your event search.
